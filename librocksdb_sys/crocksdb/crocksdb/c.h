...
extern C_ROCKSDB_LIBRARY_API void ctitandb_options_initialize_aws_sdk(
    ctitandb_options_t* options);

extern C_ROCKSDB_LIBRARY_API void ctitandb_options_shutdown_aws_sdk(
    ctitandb_options_t* options);
...
extern C_ROCKSDB_LIBRARY_API void ctitandb_options_create_cloud_env(
    ctitandb_options_t* options, char** errptr);
