...
extern "C" {
    ...
    pub fn ctitandb_options_initialize_aws_sdk(options: *mut DBTitanDBOptions);
    pub fn ctitandb_options_shutdown_aws_sdk(options: *mut DBTitanDBOptions);
    pub fn ctitandb_options_configure_bucket(
        options: *mut DBTitanDBOptions,
